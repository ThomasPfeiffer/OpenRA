...
-- Wins per faction
select raplayer.faction, count(*) from raplayer join ragame on raplayer.game_id = ragame.id where ragame.run_id  = 129 and raplayer.winner = 1 group by raplayer.faction;
...
where ragame.id in (13651, 13654, 13657, 13660, 13663, 13666, 13684, 13681, 13678, 13699, 13717, 13723, 13738, 13744, 13777, 13795, 13849, 13924, 14014, 14050, 14080, 14116, 14260, 14329, 14407, 14440, 14491, 14638, 14824, 14839, 14932, 15022, 15640, 16807, 16999);
